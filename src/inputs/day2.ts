export const input = `Game 1: 5 red, 1 green; 6 red, 3 blue; 9 red; 1 blue, 1 green, 4 red; 1 green, 2 blue; 2 blue, 1 red
...
export const testInput = `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
